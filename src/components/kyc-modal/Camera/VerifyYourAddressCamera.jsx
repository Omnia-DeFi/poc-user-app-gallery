...
function VerifyYourAddressCamera({setAddressImgSrc,twelvethStepHandler,tenthStepHandler}) {
  ...
  return (
    ...
    <div className="webcamCapture__text">
        ...
        <p className="">
            Make sure your document is inside the rectangle and is clearly visible
        </p>
        <Button 
