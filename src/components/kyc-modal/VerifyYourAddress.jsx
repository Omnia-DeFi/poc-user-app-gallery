...
function VerifyYourAddress({eleventhStepHandler,thirteenthStepHandler,ninethStepHandler}) {
  return (
    <>
    <Modal.Header>
        <div className="text-center">
            ...
            <p className="m-0">
                Please take a picture of front and back of your address legal document for KYC verification
            </p>
        </div>
    </Modal.Header>
    <Modal.Body>
        <div className="border border-2 p-5 rounded-3 text-center">
            ...
            <img width="200px" src="/images/kyc/passport.png" alt="proof of address" />
            <div className="mt-5">
                <Button
